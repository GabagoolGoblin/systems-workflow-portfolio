...
This clean-room project contains original HTML, CSS, JavaScript, Python, tests, and generated evidence. All names, tenants, paths, identifiers, payloads, messages, timestamps, and amounts are invented. It contains no employer/customer data, copied internal interface, logo, private source, live configuration, external image, or vendor behavior claim.
