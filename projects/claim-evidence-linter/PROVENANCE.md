...
This clean-room project contains original Python code, synthetic contract/evidence JSON, invented source prose, and deterministic test fixtures. It contains no employer/customer record, real applicant claim, production citation store, copied policy, external model output, logo, screenshot, or remote asset.
