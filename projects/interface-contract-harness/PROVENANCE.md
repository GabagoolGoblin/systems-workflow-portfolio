...
The parser, rules, reports, fixtures, tests, documentation, and static previews were created for this clean-room demonstration. The components are invented and contain no customer page, employer source, production identifier, copied interface, third-party logo, remote font, or external image.
